...
// Takes access token, ISO pastDays, and an object opts:
//
//   { slice_min, n }
//
...
module.exports = function predictionS (token, pastDays, opts)  {
  if (!opts)
    opts = {}
  if (!opts.slice_min)
    opts.slice_min=10
  if (!opts.n)
    opts.n=7
  let corpusS = require('./corpusS')(token, pastDays, opts.slice_min)
